...
<%			
			Orders dro = (Orders)request.getAttribute("rOrderlistdr");
			String oNd = (String)request.getAttribute("orderNamedr");
			String oPd = (String)request.getAttribute("orderPhonedr");
			String oAd = (String)request.getAttribute("orderAddrdr");
			String oMd = (String)request.getAttribute("orderMemodr");
			int drp = (Integer)request.getAttribute("drlastpay");
			int oUd = (Integer)request.getAttribute("orderUserpdr");
	        if(email == null) {
%>
...
<ul>
<li>
<img><img src='img/<%=dro.getOcdetail()%>'width='100' height='100'></img>
</li>
<li>
...
<br> 
<div class="centered"> 
<button type="button" style="color: black; background:white; font-size:14px; border-radius:0.5em; padding:5px 20px;" onclick="location.href='shopMain.do?m=orderlist'">전체 주문 내역보기</button>
