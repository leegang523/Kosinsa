...
<link href="css/styleOr.css" rel="stylesheet" type="text/css">
...
%>
	   ...
	   <br>
			...
			<center>
				<input type="button"  style="color: black; background:white; font-size:14px; border-radius:0.5em; padding:5px 20px;" value="<%=pO%>원결제하기" onclick="checkValue()">
			</center>
	<div class="clear"></div>
</section>
